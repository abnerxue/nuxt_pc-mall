          ...
          <div class="orderlist" v-for="(item,i) in orderlist" :key="i">
            ...
            <div>
              ...
              <div>
                ...
                >确认收货</span>
                <span v-if="item.payStatus==1" class="gopay"><a :href="'/index.php/user/pay_now/index.html?gid='+ item.gid +'&number=' + item.number">立即购买</a></span>
                <span v-if="item.payStatus==2" class="gopay"><a :href="'/index.php/user/pay_now/index.html?gid='+ item.gid +'&number=' + item.number">立即付款</a></span>

...
export default {
    ...
    if(this.dataseckill.endTime!=''){
      ...
      countdownj() {
           console.log(this.datalists.endTime+'52222222222222222222220')
      if(this.datalists.endTime!=undefined){
          console.log(this.datalists.endTime+'2222222222222222222220')
             const end = Date.parse(new Date(this.datalists.endTime));
      const now = Date.parse(new Date());
      const msec = end - now;
      //  console.log(this.datagroup.endTime)
      let day = parseInt(msec / 1000 / 60 / 60 / 24);
            ...
            if(this.$route.query.tag==1){
                ...
                this.gid=this.$route.query.gid
                   ...
                   console.log(res.goods)
                     ...
                     this.datalist=res.data.goods
                     this.datalists=res.data.auctionGoods
                   console.log(this.datalists.endTime+'this.datalists')
                 })

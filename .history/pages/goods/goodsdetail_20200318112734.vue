...
that.animate=!that.animate;
      ...
      let params={'token':localStorage.getItem('token'),'aid':this.datalistjj.id,'payment':2}
          // 创建form元素
    ...
    temp_form .submit();
        ...
        //    window.location =
        //         "http://tapp.huainanhui.com/index.php/api/auction/bond?token=" +
    ...
    //    params.append("token",localStorage.getItem('token'));
    //    params.append("aid",this.datalistj.id);
    //    params.append("payment",2);
    //   this.$axios.post("/api/auction/bond",params).then(res => {
    //      console.log('555')
    ...
    if(this.dataseckill.endTime!=''){
      ...
      this.interval = setTimeout(function() {
        that.countdowns();
           ...
           countdown() {
      if(this.datagroup.endTime!=''){
        //   console.log(this.datagroup.endTime+'522')

<template>
    ...
    <div class="g_top">
        ...
        <div class="gt_right">
            <p></p>
<!-- <script>$(function () {remainingTime('#timebox0')});</script> -->
           <!-- <div v-if='tag==1' >
             <div v-if='datalist=undefind'>
                        <div class="teambuy">
                    <p><i></i>限时团购</p>
                    <p>距该商品结束还剩：
                        <span id="timebox0"></span>
                    </p>
                </div>
                <div class="pt_list" v-if=''>
                    <div class='no_order'> 
                        <img src="../../static/img/noOrder.jpg" alt />
            <p>当前还没有人发起拼团哦，<br>从我开始吧！</p></div>
                    <ul class="ull">
<!-- <script>$(function () {remainingTime('#group_initiate_')});</script> -->
						<!-- <li> 用户：<span><img src=""/></span><i>&nbsp;</i>发起团购，距离结束还有<span id="group_initiate_"></span>,还差人拼成。<span ><a href="">参与拼团</a></span></li>
             ...
             <div v-else>拼团已结束</div>
           </div>  -->
<!-- <script>$(function () {remainingTime('#timebox1')});</script> -->
          
          <!-- <div v-if='tag==2'>
                <div class="seckill">
                <p><i></i>限时秒杀</p>
                <p>距该商品结束还剩：
                    <span id="timebox1"></span>
                </p>
            </div> -->
                <!-- <div class="g_detail">
                <p>
                ...
                <!-- <div class="component_price clearfix">
                    <div class="base_info f_l">
                        <h2>原价¥<strong id="deal_price" style="text-decoration:line-through;"></strong>&nbsp;&nbsp;&nbsp;&nbsp;分享推广价¥<strong id="deal_price" style="color:#f80;"></strong></h2>
                    </div>
                </div> -->
          <!-- </div> -->
<!-- <?php elseif ($activity == 4): ?> -->
            <!-- <div v-if='tag==3'>
                    <div class="g_detail">
                    <p>
                        <span>价格</span>
    ...
    <div v-if='tag==2'>
        ...
        <div class="g_number">
                ...
                <div class="g_buy">
                    ...
                    <!-- <script>
                        //秒杀
                        function buy_seckill(gid, number){
                            window.location.href = "/user/pay_now/index.html?gid=" + gid + '&number=' + number + '&activity=2&activityId=';
                        }
                    </script> -->
                </div>
    </div>
      ...
      <div v-if='tag==3'>
            ...
            <div class="g_number">
                ...
                <div class="g_buy">
                    ...
                    <!-- <script>
                        function add_bargain () {
                            window.location.href = "/user/pay_now/index.html?gid=" + <?php echo $gid; ?> + '&number=1&activity=3&activityId=<?php echo $bargain->id;?>';
                        }
                    </script> -->
                </div>
      </div>
 ...
 <div v-if='tag==4'>
     <p> {{datalist.title}}</p>
        ...
        <div class="g_number">
                ...
                <!-- <div class="g_buy">
                    <button class="buy" onclick="buy_score(<?php echo $gid;?>, $('#quantity').text(), )">立即换购</button>
                    <!-- <script>
                        //积分换购
                        function buy_score(gid, number){
                            window.location.href = "/user/pay_now/index.html?gid=" + gid + '&number=' + number + '&activity=4&activityId=<?php echo $score->id;?>';
                        }
                    </script> -->
                </div> 

                <div class="g_buy" v-if='tag==4'>
                    <!-- <button class="buy" onclick="buy(<?php echo $gid;?>, $('#quantity').text())">立即购买</button>
                    <button class="joincart" onclick="add_cart(<?php echo $gid;?>, $('#quantity').text())">加入购物车</button> -->
            ...
            if(this.$route.query.tag==1){
                ...
                this.gid=this.$route.query.gid
                   ...
                   console.log(res.goods)
                       ...
                       this.$axios.get('/api/auction/detail?auctionId='+this.$route.query.gid+'&token='+localStorage.getItem('token')).then((res)=>{
                     this.datalist=res.data.goods
                   console.log(res.goods)
                 })

 ...
 * @LastEditors: 薛松田
 * @LastEditTime: 2020-03-17 17:07:12
 -->
<!--
 * @Description: vue
 * @Version: 2.0.1.003
...
<template>
  <div>
    <div class="content">
      <div class="banner">
        <img src="../../static/img/jingjia.png" alt="" />
      </div>

      <!-- <div class='bg'></div> -->
      <div id="el-tabs-con" style="width:100%;position:relative;">
        <div
          style="position:absolute;top:0;left:0;width:100%;height:50px;background-color:#575757;"
        ></div>
        <el-tabs
          v-model="activeName"
                ...
                <li v-for="(item, i) in datalists" :key="i">
                  <div v-if="item.timeOn > 0">
                    ...
                    <div class="information">
                      ...
                      <div>
                        <p>
                          起拍价<span>¥ {{ item.startingPrice }}</span>
                        </p>
                        <!-- <del><span>¥</span></del> -->
                        <a href="#"
                          ><button class="gobuy" disabled="disabled" @click="gobuy(item.id)">
                            参与竞价
                          </button></a
                        >
                      </div>
              ...
              <ul class="goods_list">
                <li v-for="(item, i) in datalist" :key="i">
                  ...
                  <div class="information">
                    ...
                    <div>
                      <p>
                       <span>起拍价:</span><span></span><span>¥ {{ item.startingPrice }}</span>
                      </p>
                      <!-- <del><span>¥</span></del> -->
                      <a href="#"
                        ><button
                          class="gobuy"
                          @click="gobuy(item.id, item.gid)"
                        >
                          参与竞价
                        </button></a
                      >
                ...
                <li v-for="(item, i) in datalistf" :key="i">
                  ...
                  <div class="information">
                    ...
                    <div>
                      ...
                      <!-- <del><span>¥</span></del> -->
                      <a href="#"
                        ><button class="gobuy" disabled="disabled" @click="gobuy(item.gid)">
                          参与竞价
                        </button></a
                      >
                    </div>

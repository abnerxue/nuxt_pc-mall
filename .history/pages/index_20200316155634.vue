 ...
 * @LastEditors: 薛松田
 * @LastEditTime: 2020-03-16 15:56:34
 -->
<template>
  <div>
    <el-carousel
    ...
    <div class="content_box">
      <div class="content">
        <div class="team_kill">
          ...
          <div>
            <div>
              <img src="../static/img/tuangou1.jpg" alt="" />
...
export default {
  async asyncData({params}) {
    ...
    return axios({
      method: "get",
      url: "http://tapp.huainanhui.com/api/pc/index"
    }).then(function(response) {
      console.log(response.data+'opoop');
      // return { info: response.data };
      return{ dataseckill : response.data.seckill,
        datagroup : response.data.group,
        carousel:response.data.slide,
        data : response.data.category.first,
        datasceond :Object.values(response.data.category.second),
        // countdown();
        // countdowns()
        }
      error(params);

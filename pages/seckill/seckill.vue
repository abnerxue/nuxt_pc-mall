 ...
 * @LastEditors: 薛松田
 * @LastEditTime: 2020-03-17 10:07:01
 -->
<template>
    <div>
        <div class="content">
   ...
   <div id="el-tabs-con" style="width:100%;position:relative;">
                ...
                <div v-if='item.timeOn>0'>
                    ...
                    <div class="information">
                        ...
                        <div>
                            ...
                            <!-- <del><span>¥</span></del> -->
                            <a href="#"><button class="gobuy" disabled="disabled" @click="gobuy(item.id)">去抢购</button></a>
                        </div>
                    </div>
                    <div class="appraise">
    ...
    <el-tab-pane label="未开始" name="third">
                ...
                <li  v-for="(item,i) in datalistf" :key='i'  >
                    ...
                    <div class="information">
                        ...
                        <div>
                            <p><span>¥ {{item.price}}</span></p>
                            <!-- <del><span>¥</span></del> -->
                            <a href="#"><button class="gobuy"  disabled="disabled" @click="gobuy(item.gid)">去抢购</button></a>
                        </div>
                    </div>
                    <div class="appraise">
        ...
        <!-- <ul>
            ...
            <li><a href="?part=3">已结束</a></li>
            <li><a href="?part=2">抢购中</a></li>
            <li><a href="?part=1" >未开始</a></li>
        </ul> -->
                ...
                <li  v-for="(item,i) in datalist" :key='i'>
                    ...
                    <div class="information">
                        ...
                        <div>
                            <p><span>¥ {{item.price}}</span></p>
                             <del><span>¥</span></del> 
                            <a href="#"><button class="gobuy">去抢购</button></a>
                        </div>
                    </div>
                    <div class="appraise">
      ...
      if (tab.name === 'first') {
        ...
        getlist(){
            ...
            if(this.activeName=='first'){
                 ...
                 this.$axios.get('/api/seckill/goods_list?type='+1).then((res)=>{
                     this.datalist=res.data.list
                   console.log(res.data.list)
                 })
            }else if(this.activeName=='second'){
                   this.$axios.get('/api/seckill/goods_list?type='+2).then((res)=>{
                     this.datalist=res.data.list
                   console.log(res.data.list)
                 })
            }else{
                   this.$axios.get('/api/seckill/goods_list?type='+3).then((res)=>{
                     this.datalist=res.data.list
                   console.log(res.data.list)
                 })
            }
